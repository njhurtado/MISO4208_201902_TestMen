...
.field final Hu:Ljava/lang/String;
...
.method constructor <init>(ILjava/lang/String;JJI)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/drive/DriveId;->Hf:Ljava/lang/String;

    iput-object v0, p0, Lcom/google/android/gms/drive/DriveId;->Hx:Ljava/lang/String;

    iput p1, p0, Lcom/google/android/gms/drive/DriveId;->mVersionCode:I

    iput-object p2, p0, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v2}, Lcom/google/android/gms/common/internal/zzac;->zzbs(Z)V

    iput-wide p3, p0, Lcom/google/android/gms/drive/DriveId;->Hv:J

    iput-wide p5, p0, Lcom/google/android/gms/drive/DriveId;->Hd:J

    iput p7, p0, Lcom/google/android/gms/drive/DriveId;->Hw:I
...
.method private zzbaz()[B
    .locals 4

    new-instance v0, Lcom/google/android/gms/internal/zzso;

    invoke-direct {v0}, Lcom/google/android/gms/internal/zzso;-><init>()V

    iget-wide v2, p0, Lcom/google/android/gms/drive/DriveId;->Hv:J

    iput-wide v2, v0, Lcom/google/android/gms/internal/zzso;->Lo:J

    iget-wide v2, p0, Lcom/google/android/gms/drive/DriveId;->Hd:J

    iput-wide v2, v0, Lcom/google/android/gms/internal/zzso;->Ll:J
...
.method public static zzin(Ljava/lang/String;)Lcom/google/android/gms/drive/DriveId;
    .locals 7
...
.method static zzs([B)Lcom/google/android/gms/drive/DriveId;
    ...
    :try_start_0
    invoke-static {p0}, Lcom/google/android/gms/internal/zzsn;->zzt([B)Lcom/google/android/gms/internal/zzsn;
    :try_end_0
    ...
    iget-object v2, v0, Lcom/google/android/gms/internal/zzsn;->Ln:Ljava/lang/String;
    ...
    iget v2, v0, Lcom/google/android/gms/internal/zzsn;->versionCode:I

    iget-wide v4, v0, Lcom/google/android/gms/internal/zzsn;->Lo:J

    iget-wide v6, v0, Lcom/google/android/gms/internal/zzsn;->Ll:J

    iget v8, v0, Lcom/google/android/gms/internal/zzsn;->Lp:I
    ...
    :cond_0
    iget-object v3, v0, Lcom/google/android/gms/internal/zzsn;->Ln:Ljava/lang/String;
...
.method public asDriveFile()Lcom/google/android/gms/drive/DriveFile;
    ...
    iget v0, p0, Lcom/google/android/gms/drive/DriveId;->Hw:I
...
.method public final encodeToString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/DriveId;->Hf:Ljava/lang/String;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/android/gms/drive/DriveId;->zzbat()[B
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-wide v2, p1, Lcom/google/android/gms/drive/DriveId;->Hd:J

    iget-wide v4, p0, Lcom/google/android/gms/drive/DriveId;->Hd:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_0

    iget-wide v2, p1, Lcom/google/android/gms/drive/DriveId;->Hv:J
    ...
    iget-object v0, p1, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;

    iget-object v1, p0, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;

    if-eqz v2, :cond_3

    iget-object v2, p1, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;
    ...
    iget-wide v4, p0, Lcom/google/android/gms/drive/DriveId;->Hv:J
    ...
    iget-object v3, p0, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;
...
.method public getResourceId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/DriveId;->Hu:Ljava/lang/String;
...
.method public hashCode()I
    ...
    iget-wide v0, p0, Lcom/google/android/gms/drive/DriveId;->Hv:J
    ...
    :cond_0
    iget-wide v0, p0, Lcom/google/android/gms/drive/DriveId;->Hd:J
...
.method public final toInvariantString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/DriveId;->Hx:Ljava/lang/String;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/gms/drive/DriveId;->zzbaz()[B
...
.method final zzbat()[B
    ...
    invoke-direct {v1}, Lcom/google/android/gms/internal/zzsn;-><init>()V

    iget v0, p0, Lcom/google/android/gms/drive/DriveId;->mVersionCode:I

    iput v0, v1, Lcom/google/android/gms/internal/zzsn;->versionCode:I
    ...
    :goto_0
    iput-object v0, v1, Lcom/google/android/gms/internal/zzsn;->Ln:Ljava/lang/String;

    iget-wide v2, p0, Lcom/google/android/gms/drive/DriveId;->Hv:J

    iput-wide v2, v1, Lcom/google/android/gms/internal/zzsn;->Lo:J

    iget-wide v2, p0, Lcom/google/android/gms/drive/DriveId;->Hd:J

    iput-wide v2, v1, Lcom/google/android/gms/internal/zzsn;->Ll:J

    iget v0, p0, Lcom/google/android/gms/drive/DriveId;->Hw:I

    iput v0, v1, Lcom/google/android/gms/internal/zzsn;->Lp:I
